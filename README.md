...
- [src](https://github.com/lalagkaspn/genetic_similarity_drug_discovery/tree/main/src) contains all source code for data preparation, model training and evaluation, and figure/table generation. STAN model is also included here.
...
- [results](https://github.com/lalagkaspn/genetic_similarity_drug_discovery/tree/main/results) includes the predicted drug indications and side effects, as well as results from the direct genetic evidence analysis for our predictions (used in Supplementary Figure 10). This data is used to generate all figures and supplementary tables.
- [tables](https://github.com/lalagkaspn/genetic_similarity_drug_discovery/tree/main/tables) contains two supplementary tables:
    - `Supplementary table 1`: clean list of predicted drug-disease indications
    - `Supplementary table 2`: clean list of predicted drug-disease side effects
    - Both tables include the estimated predicted probabiliies and the corrresponding known drug indications or side effects whose genetic similarity to the test disease was used for making the prediction.
